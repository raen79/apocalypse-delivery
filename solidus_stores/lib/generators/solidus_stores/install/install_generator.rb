...
module SolidusStores
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        inject_into_file 'vendor/assets/stylesheets/spree/frontend/all.css', " *= require spree/frontend/solidus_stores\n", before: %r{\*/}, verbose: true # rubocop:disable Metrics/LineLength
        inject_into_file 'vendor/assets/stylesheets/spree/backend/all.css', " *= require spree/backend/solidus_stores\n", before: %r{\*/}, verbose: true # rubocop:disable Metrics/LineLength
      end

      def add_migrations
        run 'bin/rails railties:install:migrations FROM=solidus_stores'
      end
